...
function App() {
  ...
  }), [wacc, mktDecline, pricing.infPrice, pricing.trainPrice, weakUtilFloor, arrRunM, prepaidCapPct]);
          ...
          {[
            ...
            },
            {
              ...
              items: [
                ...
                "Portfolio checks (any one flips the candidate to DECLINE): no single vendor above 40% of the book once the book exceeds 2,000 GPUs, cumulative prepaid cash outstanding within the ARR cap set below, no Bronze operator carrying more than 10% of ARR in prepay, and no plain-Ethernet fabric under a training-class chip.",
              ],
            },
            {
...
export default function App() {
  const [side, setSide] = useState("projections");
  const tabs = [
